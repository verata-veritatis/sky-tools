...
print("")
GATE = input("{}WARNING: Your IP address has been recorded as {}. Would you like to continue? (Y or N):{} ".format(Back.BLUE, IP_TEST.rstrip(), Style.RESET_ALL))
if GATE.upper() == 'Y':
    pass
else:
    print("")
...
Would you like to place a trailing stop/stop-loss or stoploss only?")
    ...
    Qty = Qty // float(sPrecision) * float(sPrecision)
