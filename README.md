...
To check that you have installed Python, open up Terminal or Command Prompt and type the following commands.  
...
You should see your version of the Python language. For example, OSX will simply return `Python 2.7.14`, while Windows will display:
```
